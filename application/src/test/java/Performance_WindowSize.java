...
public class Performance_WindowSize {
    ...
    public void test_150x100_w32_cRED() throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException, InterruptedException {
        String[] args = new String[] {"-c", "RED", "-w", "32", "-f", "150x100-koralli-mirrored-top-blur.png", "150x100-koralli-mirrored-left-blur.png", "150x100-koralli-mirrored-right-blur.png", "-o", "../../test/resources/test_output_%s_%d.png", "-d"};
        Object[] args2 = {args};
    ...
    public void test_150x100_w64_cRED() throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException, InterruptedException {
        String[] args = new String[] {"-c", "RED", "-w", "64", "-f", "150x100-koralli-mirrored-top-blur.png", "150x100-koralli-mirrored-left-blur.png", "150x100-koralli-mirrored-right-blur.png", "-o", "../../test/resources/test_output_%s_%d.png", "-d"};
        Object[] args2 = {args};
